...
class Reglement
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="AppBundle\Entity\Concours")
     ...
     *
     * @Vich\UploadableField(mapping="concours_image", fileNameProperty="imageName", size="imageSize", nullable=true)
     *
     * @var File
     */
    private $imageFile;
